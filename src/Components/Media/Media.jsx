    ...
    return (
        <div className="w-[80vw] mx-auto pt-[10vh] pb-[10vh]  ">
            ...
            <div className=" grid grid-cols-3 sm:grid-cols-6 gap-4">
                <Link to = '/airport'>
                    <div className="sm:w-[180px] w-[100px] h-[110px] py-10 px-5 bg-black text-white rounded-md border-[3px] border-orange-400 isolate aspect-video  shadow-lg ring-1 ring-black/5">
