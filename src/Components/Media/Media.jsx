    ...
    return (
        <div className="w-[85vw] mx-auto pt-[10vh] pb-[10vh]">
            ...
            <div className=" grid grid-cols-3 sm:grid-cols-6 gap-4">
                <Link to='/airport'>
                    <div className="flex flex-col justify-center items-center gap-2 sm:w-[180px] w-[110px] h-[110px] sm:py-10 sm:px-5 bg-black text-white rounded-md border-[3px] border-[#FF0000] isolate aspect-video  shadow-lg ring-1 ring-black/5">
                        <i className="fa-solid fa-plane-departure fa-xl sm:fa-2xl mt-3"></i>
                        <p className="mt-2">Airport</p>
                    </div>
                </Link>
                <Link to='/cinema'>
                    <div className="flex flex-col justify-center items-center gap-2 sm:w-[180px] w-[110px] h-[110px] py-10 px-5 bg-black text-white rounded-md border-[3px] border-[#FF0000] isolate aspect-video  shadow-lg ring-1 ring-black/5">
