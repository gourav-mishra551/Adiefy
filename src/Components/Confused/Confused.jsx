...
const Confused = () => {
    return (
        <div className="w-[80vw] mx-auto flex sm:flex-row flex-col sm:mt-0 mt-10">
            <div className="left sm:flex-col flex-row my-auto justify-center align-middle ">
                <h2 className="sm:text-[32px] text-[22px] font-bold">Confused ?</h2>
                <h2 className="sm:text-[28px] text-[18px] font-bold">We can help you plan the perfect campaign!</h2>
                <p className="mb-10 text-[16px] sm:text-[24px] font-semibold">Hire our expert media planners to find, plan and place your next promotion.</p>
