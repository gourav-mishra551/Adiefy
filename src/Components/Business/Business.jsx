      ...
      <div className="flex sm:flex-row sm:gap-0 gap-10 flex-col justify-center align-middle md:w-[80vw] sm:w-[70vw] w-[70vw] mx-auto mt-10">
        <div className="banner1 flex flex-col w-auto sm:w-80 mx-8">
          <div className="up rounded-t-full mb-2">
            <img className="bg-cover rounded-t-full sm:h-[50vh]" src="./add1.jpg" alt="ads 1" />
          </div>
        ...
        <div className="banner2 flex flex-col w-auto sm:w-80 mx-8">
          <div className="up rounded-t-full mb-2">
            <img className="bg-cover rounded-t-full sm:h-[50vh]" src="./ads3.jpg" alt="ads 1" />
          </div>
          <div className="bottom rounded-lg p-8 bg-white">
            <h2 className="font-semibold sm:text-[16px] text-[14px] text-black">Exposure Express</h2>
            <p className="sm:text-[14px] text-[12px] text-gray-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magnam exercitationem nisi ipsa architecto eius illum?</p>
        ...
        <div className="banner3 flex flex-col w-auto sm:w-80 mx-8">
          <div className="up rounded-t-full mb-2">
            <img className="bg-cover rounded-t-full sm:h-[50vh]" src="./ads2.jpg" alt="ads 1" />
          </div>
          <div className="bottom rounded-lg p-8 bg-white">
            <h2 className="font-semibold sm:text-[16px] text-[14px] text-black">Exposure Express</h2>
            <p className="sm:text-[14px] text-[12px] text-gray-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magnam exercitationem nisi ipsa architecto eius illum?</p>
